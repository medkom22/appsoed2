...
List<FakultasModel> dataFakultas = [
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/PT49nrf1QHoeFZKXA',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/5xcquZ4XSEkC4cKp8',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/5ywXMbsVeqWq8hKGA',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/p4v6Bk3zn6EDA1D38',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/hrtHdpZ1QGbeah7x5',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/D5zG4PAFL4Q8VT8S8',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/x5HVJMju2oHVjV4Y8',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/fUwqkQYe4e2SKueZ8',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/P3JXNwK4ufbjoaMr6',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/aRs5PddgnyUEarCn9',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/47Rrogud432dfWV8A',
  ...
  FakultasModel(
    ...
    lokasi: 'https://goo.gl/maps/SJNvPsxqVid5FgTo6',
    instagram: 'https://www.instagram.com/faperta.unsoed/',
    website: 'http://faperta.unsoed.ac.id/',
    gallery: [
